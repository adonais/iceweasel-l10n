...
preferences-profiles-subpane-description =
    .description = 每套設定檔的瀏覽資料與設定（包含瀏覽紀錄、網頁密碼等等）各自獨立，不互相影響。
...
sync-engine-addons =
    .label = 附加元件
    .tooltiptext = { -brand-short-name } 桌機版的擴充套件與佈景主題
    .accesskey = A
...
preferences-doh-strict-detailed-desc-2 = 無法使用安全 DNS 時總是警告我
...
preferences-doh-overview-default =
    .description = 在可用的地方就使用安全 DNS。
    .label = 預設保護
preferences-doh-overview-custom =
    .description = 總是使用安全 DNS，自行控管 DNS 業者與備用行為。
    .label = 自訂
...
preferences-doh-radio-default =
    .description = 在可用地區就使用安全 DNS 進行查詢
    .label = 預設
preferences-doh-radio-custom =
    .description = 總是使用安全 DNS，並自行控制提供者與備用行為
    .label = 自訂
preferences-doh-radio-off =
    .description = 使用預設的 DNS 解析器
    .label = 關閉
preferences-doh-fallback-label =
    .label = 無法使用安全 DNS 時，總是警告我
...
iceweasel-tabcompactmode-warning1 = 如果你確實認為它們的高度不合理。
iceweasel-taskbartabs-description = Mozilla 開發的新功能就是為了讓人們禁用它。
iceweasel-taskbartabs-warning1 = 把分頁固定到操作系統任務欄, 有什么意義?
...
iceweasel_addons_multiline_description = 無限行分頁
...
mouse_gestures_previous_page = 上一頁
...
reload_download_finish = 讀取 Upcheck 支持的下載工具完成，請選擇你喜歡的下載工具
download_through_upcheck = 使用 Upcheck 下載
download_by_default = 使用默認工具下載
