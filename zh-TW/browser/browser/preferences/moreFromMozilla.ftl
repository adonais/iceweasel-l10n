...
more-from-moz-firefox-mobile-title = { -vendor-short-name } 行動版
more-from-moz-firefox-mobile-description = 把您的隱私權置於最優先的行動瀏覽器。
more-from-moz-firefox-mobile-title-1 = { -vendor-short-name } 行動版
more-from-moz-firefox-mobile =
    .label = { -vendor-short-name } 行動版
...
more-from-moz-qr-code-firefox-mobile-img =
    .alt = { -vendor-short-name } 行動版的下載 QR Code
