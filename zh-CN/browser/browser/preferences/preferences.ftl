...
preferences-doh-radio-group =
    .aria-label = “基于 HTTPS 的 DNS”启用策略：
...
iceweasel_addons_multiline_description = 无限行标签
...
mouse_gestures_update_new2 = 服务端发布了新版本, 前往下载?
