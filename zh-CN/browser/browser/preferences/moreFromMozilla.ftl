...
more-from-moz-firefox-mobile-title = { -vendor-short-name } 移动版
more-from-moz-firefox-mobile-description = 隐私为先的移动浏览器。
more-from-moz-firefox-mobile-title-1 = 移动版 { -vendor-short-name }
more-from-moz-firefox-mobile =
    .label = 移动版 { -vendor-short-name }
...
more-from-moz-qr-code-firefox-mobile-img =
    .alt = 二维码：下载 { -vendor-short-name } 移动版
