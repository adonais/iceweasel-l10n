...
tab-group-editor-title-suggest = 标签建议
...
tab-group-editor-smart-suggest-button-create =
    .label = 推荐更多的标签页
tab-group-editor-suggestions-header = 标签建议
tab-group-suggestions-loading-header = 标签建议
...
tab-group-editor-no-tabs-found-message = 打开的相似标签页，AI将推荐一个名称并将这些标签页智能分组。
# Message is shown to the user whenever there are smart tags suggest
tab-group-editor-information-message = AI根据此窗口中相似的标签页建议名称和标签。
# Title appears when user is shown the opt-in flow to use smart tab grouping
tab-group-suggestions-optin-title = 推荐更多的标签页
# Message appears when user is shown the opt-in flow to use smart tab grouping
tab-group-suggestions-optin-message = 在你的设备上，{ -brand-short-name } 使用AI读取打开标签页的标题和描述 <a data-l10n-name="support">推荐更多的标签和组名</a>。
tab-group-suggestions-optin-title-download = 正在查找建议 …
tab-group-suggestions-optin-message-download = 这可能需要一点时间。
tab-group-suggestions-optin-message-footer = 在<a data-l10n-name="settings">设置</a> 选项中自定义AI
